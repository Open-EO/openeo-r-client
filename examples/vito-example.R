...
task = pgb$collection$BIOPAR_FAPAR_V1_GLOBAL %>% pgb$filter_bbox(left = 16.138916, bottom = 48.1386, right = 16.524124, top = 48.320647, srs = "EPSG:4326") %>% 
    pgb$filter_daterange(from = "2016-01-01T00:00:00Z", to = "2016-03-10T23:59:59Z") %>% pgb$NDVI() %>% pgb$min_time()
