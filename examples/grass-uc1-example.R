...
filter_bbox_1 = process(process_id = "filter_bbox",collections=list(s2a_b04), bottom=38.9, left=-4.8,right=-4.6,top=39.1,ewres=0.0001, nsres=0.0001, srs="EPSG:4326")
...
filter_bbox_2 = process(process_id="filter_bbox",collections=list(s2a_b08), bottom=38.9, left=-4.8,right=-4.6,top=39.1,ewres=0.0001, nsres=0.0001, srs="EPSG:4326")
